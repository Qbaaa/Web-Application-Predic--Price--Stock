...
import com.qbaaa.stockpricepredict.service.ApiFinancialService;
...
public class Starter implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if(!roleRepository.existsByRole(ERole.ROLE_USER))
        {
            ...
            User user4 = new User("Jakub","jakub@gmail.pl",passwordEncoder.encode("jakub123"));
    ...
    {
        List<HistoricalPriceCompanies> listHistoricalPriceCompanies = apiFinancialService.ReadingHistorialPriceStock(symbolStock, dateStrat, dateEnd);
        historicalPriceCompaniesRepository.saveAll(listHistoricalPriceCompanies);
    }
}
